...
Bisherige Arbeiten beschreiben Speedrunning-Weltrekordkurven auf Makroebene~\cite{erdil2023}, lassen jedoch offen, welche Mechanismen kurzfristige Beschleunigungen innerhalb einer Weltrekordreihe auslösen und wie nah menschliche Weltrekorde dem theoretischen Optimum kommen. Diese Arbeit adressiert beide Lücken: Sie operationalisiert erstmals die \emph{Post-Breakthrough-Dynamik}~(F3a) --- die Reaktion einer Community auf ein identifizierbares Schlüsselereignis --- sowie die \emph{Annäherungsrate} an das TAS-Zeitminimum~(F3b) für einen kontrollierten Mehrspielen-Datensatz. Die Beiträge zu bestehendem Wissen sind: (1)~reproduzierbare Quantifizierung beider Effekte mit öffentlich zugänglichen Daten, (2)~Genre- und Spielvergleich für F1 und F3c auf einer einheitlichen Datenbasis, (3)~Modellvergleich für Sättigungsmuster über fünf Kurventypen~(F2).
