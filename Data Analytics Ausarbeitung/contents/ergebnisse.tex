...
Auf Genre-Ebene zeigen sich deutliche Unterschiede in der mittleren Gesamtreduktion: Sandbox~(98,9~\%), Puzzle~(80,7~\%), Action-Adventure~(67,5~\%) und FPS~(61,5~\%) liegen deutlich über Arcade~(41,9~\%), Platformer~(38,5~\%) und RPG~(24,2~\%). Der Kruskal-Wallis-Test auf die \emph{jährlichen Verbesserungsraten} ergibt jedoch keinen signifikanten Unterschied zwischen den sieben~Genres ($H = 4{,}48$; $p = 0{,}483$).
